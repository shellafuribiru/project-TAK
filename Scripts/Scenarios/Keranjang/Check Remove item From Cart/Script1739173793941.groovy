...
WebUI.callTestCase(findTestCase('Blocks/Cart Management/Remove Item from Cart'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Blocks/Cart Management/Empty State'), [:], FailureHandling.STOP_ON_FAILURE)
